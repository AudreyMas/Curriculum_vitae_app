...
CREATE TABLE `curriculum_vitae` (
  `curriculum_vitae_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `language_id` int NULL,
  `skill_id` int NULL,
  `education_id` int NULL,
	`work_experience_id` int NULL,
  `work_references_id` int NULL,
  FOREIGN KEY (`user_id`) REFERENCES `user`(`user_id`),
  FOREIGN KEY (`language_id`) REFERENCES `languages`(`language_id`),
  FOREIGN KEY (`skill_id`) REFERENCES `skills`(`skill_id`),
  FOREIGN KEY (`education_id`) REFERENCES `education`(`education_id`),
  FOREIGN KEY (`work_experience_id`) REFERENCES `work_experience`(`work_experience_id`),
  FOREIGN KEY (`work_references_id`) REFERENCES `work_references`(`work_references_id`),
  PRIMARY KEY (`curriculum_vitae_id`)
);*/
